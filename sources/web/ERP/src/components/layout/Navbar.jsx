      ...
      <div className="flex items-center gap-6">
        ...
        <div className="hidden md:flex relative group">
          ...
          <input 
            ...
            className="pl-9 pr-4 py-2 bg-slate-100 border-transparent rounded-full text-sm w-64 focus:bg-white focus:border-primary-300 focus:ring-2 focus:ring-primary-100 transition-all outline-none"
          />
        </div>
