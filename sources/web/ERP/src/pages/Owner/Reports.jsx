    ...
    <div className="max-w-7xl mx-auto pb-24">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-slate-500 mt-2">Comprehensive view of your business performance.</p>
        </div>
        ...
        <div className="flex gap-2">
          <div className="relative">
            <select 
              ...
              className="appearance-none bg-white border border-slate-200 rounded-lg pl-4 pr-10 py-2.5 text-sm font-semibold text-slate-700 focus:outline-none focus:ring-2 focus:ring-primary/50 shadow-sm"
            >
          ...
          <div className="bg-slate-200/50 p-1 rounded-lg flex inline-flex">
            {PERIODS.map(p => (
              <button
                key={p}
                onClick={() => setPeriod(p)}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="card p-6 flex flex-col justify-between">
          <div className="flex justify-between items-start mb-4">
            ...
            <span className="flex items-center text-sm font-bold text-green-600 bg-green-50 px-2 py-1 rounded-md">
              <TrendingUp className="w-3 h-3 mr-1" /> {SUMMARY_DATA.trend}%
            </span>
          </div>
          <p className="text-sm font-semibold text-slate-500 mb-1">Gross Revenue</p>
          <h3 className="text-3xl font-bold text-slate-800 font-heading">₹{SUMMARY_DATA.revenue.toLocaleString()}</h3>
        </div>
        ...
        <div className="card p-6 flex flex-col justify-between">
          ...
          <h3 className="text-3xl font-bold text-slate-800 font-heading">{SUMMARY_DATA.orders}</h3>
        </div>
        ...
        <div className="card p-6 flex flex-col justify-between">
          ...
          <h3 className="text-3xl font-bold text-slate-800 font-heading">₹{SUMMARY_DATA.avgValue.toLocaleString()}</h3>
        </div>
        ...
        <div className="card p-6 flex flex-col justify-between">
          ...
          <h3 className="text-3xl font-bold text-slate-800 font-heading">₹{SUMMARY_DATA.tax.toLocaleString()}</h3>
        </div>
      </div>
