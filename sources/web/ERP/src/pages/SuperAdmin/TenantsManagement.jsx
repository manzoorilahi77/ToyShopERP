...
import { Store, Plus, Search, MoreVertical, ShieldAlert, CheckCircle2 } from 'lucide-react';
import { motion } from 'framer-motion';

const MOCK_TENANTS = [
  { id: 'T001', name: 'ToyShop Central', owner: 'Priya N.', plan: 'Pro', status: 'Active', branches: 4, revenue: '₹42,500/mo' },
  { id: 'T002', name: 'Kids Paradise', owner: 'Rahul K.', plan: 'Starter', status: 'Active', branches: 1, revenue: '₹12,000/mo' },
  { id: 'T003', name: 'Fun Zone Toys', owner: 'Amit S.', plan: 'Pro', status: 'Suspended', branches: 2, revenue: '₹24,000/mo' },
  { id: 'T004', name: 'Little Einstein', owner: 'Neha M.', plan: 'Enterprise', status: 'Active', branches: 12, revenue: '₹1,45,000/mo' },
];
